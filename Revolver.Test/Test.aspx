  ...
  <body>
    <form id="form1" runat="server">
      <div>
        ...
        <p>If no categories are selected the entire suite will run excluding the performance tests.</p>
        <p>
          <a href="javascript:void(0)" onclick="checkAll(true);">select all</a>
          <a href="javascript:void(0)" onclick="checkAll(false);">unselect all</a>
        </p>
